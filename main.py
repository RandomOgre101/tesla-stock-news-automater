...
# Getting today, yesterday and day before yesterday in YYYY-MM-DD format
today = dt.date.today()
yesterday = today- timedelta(days = 1)
day_before = today - timedelta(days = 2)


# Accessing the AlphaVantage Stock API
...
# Getting the news articles related to Tesla Inc
